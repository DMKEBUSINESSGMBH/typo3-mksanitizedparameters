...
$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/index_ts.php']['preprocessRequest'][] = 
	'EXT:'.$_EXTKEY.'/hooks/class.tx_mksanitizedparameters_hooks_Frontend.php:tx_mksanitizedparameters_hooks_Frontend->preprocessRequest';

// sanitize in BE
$TYPO3_CONF_VARS['SC_OPTIONS']['typo3/template.php']['preStartPageHook'][] = 
	'EXT:'.$_EXTKEY.'/hooks/class.tx_mksanitizedparameters_hooks_Backend.php:tx_mksanitizedparameters_hooks_Backend->preStartPageHook';
